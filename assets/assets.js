...
export const categories = ["Headphones", "Speakers", "Watch", "Earbuds", "Mouse", "Phone Covers", "Decoration", "हवन सामग्री", "राशन", "Clothes"];
...
export const ourSpecsData = [
    { title: "Free Shipping", description: "Enjoy fast, free delivery on every order no conditions, just reliable doorstep on order above Rs. 500/-", icon: SendIcon, accent: '#05DF72' },
    { title: "7 Days easy Return", description: "Return Feature is Available on product above Rs. 799/-", icon: ClockFadingIcon, accent: '#FF8904' },
