            ...
            <div className='flex max-xl:flex-col gap-8 max-w-7xl mx-auto my-10'>
                <div className='relative flex-1 flex flex-col bg-blue-200 rounded-3xl xl:min-h-100 group'>
                    <div className='p-5 sm:p-16'>
                        <div className='inline-flex items-center gap-3 bg-blue-300 text-white-600 pr-4 p-1 rounded-full text-xs sm:text-sm'>
                            <span className='bg-green-600 px-3 py-1 max-sm:ml-1 rounded-full text-white text-xs'>NEWS</span> Free Shipping on Orders Above ₹500!&nbsp; &nbsp;|&nbsp;&nbsp;₹500 से अधिक के ऑर्डर पर फ्री शिपिंग! <ChevronRightIcon className='group-hover:ml-2 transition-all' size={16} />
                        </div>
                        <h2 className='text-3xl sm:text-5xl leading-[1.2] my-3 font-medium bg-gradient-to-r from-blue-600 to-cyan-400 bg-clip-text text-transparent max-w-xs sm:max-w-md'>
                            Ab sab kuch kharidna hua आसान, ek दुकान, sab सामान
                        </h2>
